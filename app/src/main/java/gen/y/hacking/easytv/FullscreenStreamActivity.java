...
import gen.y.hacking.easytv.util.SystemUiHider;
 ...
 * @see SystemUiHider
 */
public class FullscreenStreamActivity extends Activity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final View contentView = findViewById(R.id.fullscreenVideoView);
        ...
        myVideoView = (VideoView)this.findViewById(R.id.fullscreenVideoView);
